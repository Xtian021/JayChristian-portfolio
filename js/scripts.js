/* =========================================================
   JAY CHRISTIAN BACCAY
   PORTFOLIO — CUSTOM JAVASCRIPT
   Smooth • Responsive • Bug-Safe
========================================================= */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* =======================================================
     ...
     JavaScript does NOT move these elements.
  ======================================================= */

  /*
    .tech-float elements intentionally have no JavaScript
    movement here.

    Their animation should be defined in style.css using
    @keyframes.

    This prevents conflicts with the rest of the portfolio.
  */
